...
order: 2
date: 2019-08
team: [{ name: "Iouri Sorokine", url: "https://github.com/iourisorokine" }]
banner: "/images/projects/fresh-mentor/fresh-mentor-banner.png"
shortDescription: Personal news and event aggregator for learning technologies
category: 💻 Tech Learner Community
type: backend
url: https://fresh-mentor.herokuapp.com/
technologies:
  [
    Node.js,
    Express.js,
...
<TLDR>
  <p>
    During the fifth week of Ironhack Berlin's Full Stack Web Developer
    Bootcamp, we were challenged to design and create a full stack app. The
    "industry", or ideation was totally on us.
  </p>
  <br />
  <p>
    After some conversation, both me and{" "}
    <NextLink
      textDecoration="underline"
      href="https://github.com/iourisorokine"
    >
      Iouri
    </NextLink>{" "}
    figured that we wanted to work with external APIs, and create ssomething
    that could tackle a pain point.
  </p>
  <br />
  <p>
    Both of us had started learning how to code before the Bootcamp and faced
    the same struggles. We learned alone, we went to some meetups for
    co-learning and met different people around the city.
  </p>
  <br />
  <p>
    One thing was clear, experienced feedback is always tremendously valuable,
    and learning together is, usually, much more fun.
  </p>
</TLDR>
