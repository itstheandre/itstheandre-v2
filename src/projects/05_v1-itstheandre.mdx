...
order: 5
date: 2019-05
team: [{ name: "Catarina Rosa", url: "https://catarinarosa.co" }]
technologies: [Gatsby.js, React.js, Sanity.io, GraphQL, Styled-Components]
banner: "/images/projects/v1/v1-banner.png"
shortDescription: 1st Version of my portfolio
category: 💄 Portfolio Creation
type: frontend
url: https://v1.itstheandre.com
---

<TLDR>
  <p>
    There was once a couple of belgian entrepreneurs that moved to the US. And
    there they realized that good quality belgian products wed me to put my
    things live, but also because it proved to me what I could, and could not,
    build.
  </p>
  <br />
  <p>
    In this this first practice I decided to use techonologies I was already
    feeling comfortable, but also to develop a very first draft of a blog /
    structure for anyone to be able to put their stuff online.
  </p>
</TLDR>

#### <EmojiWrapper>🧔</EmojiWrapper> Hello... It's me
